...
import com.metax.system.service.*;
...
public class SysUserController extends BaseController implements RemoteUserService {
	...
	@Override
	public R<LoginUser> getUserInfo(@PathVariable("username") String username, String source) {
	...
	@Override
	public R<Boolean> registerUserInfo(@RequestBody SysUser sysUser, String source) {
